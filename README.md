...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ecjop0e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ecjop0e.containers.anotherwebservice.com/
...
```
git clone git@github.com:WhiteNeone00/container-ecjop0e.git
cd container-ecjop0e
```
...
```
docker attach container-ecjop0e
```
